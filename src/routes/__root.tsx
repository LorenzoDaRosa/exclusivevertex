...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "google-site-verification", content: "dPhTJL9HSis2I-IbnykFc_tCwY0hH5EhO1RuP5lL0jk" },
    ...
    links: [
      ...
      { rel: "icon", href: "/vertex-favicon.png", type: "image/png", sizes: "512x512" },
      { rel: "shortcut icon", href: "/favicon.ico" },
      { rel: "apple-touch-icon", href: "/vertex-favicon.png" },
        ...
        <script
          dangerouslySetInnerHTML={{
            __html: `
              (function() {
                try {
                  const theme = localStorage.getItem('vx-theme');
